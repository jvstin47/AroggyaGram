...
_buildCard(context, Icons.auto_awesome, "AI Consult", Colors.blue, const GeminiConsultationPage()),
_buildCard(context, Icons.alarm, "Medication", Colors.orange, const MedsTrackerPage()),
_buildCard(context, Icons.translate, "Translate", Colors.purple, const TranslatePage()),
            ],
          ),
